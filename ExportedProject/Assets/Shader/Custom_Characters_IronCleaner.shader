Shader "Custom/Characters/IronCleaner" {
	Properties {
		...
		[KeywordEnum(On, Off)] _Dissolve ("Dissolve", Float) = 0
		[ToggleOff] _DissolveInvert ("Invert dissolve", Float) = 0
		...
		_DissolveStartTime ("Dissolve start time", Float) = 0
