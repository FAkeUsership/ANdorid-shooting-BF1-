Shader "Custom/Core/DiffuseEmissiveShadowClamping" {
	Properties {
		_MainTex ("Texture", 2D) = "white" {}
		_EmissTex ("Emissive Texture", 2D) = "black" {}
		_EmissIntensity ("Emissive Intensity", Float) = 1
		_TintColor ("Color", Vector) = (1,1,1,1)
		_LightBrightness ("Light Brightness", Range(0, 4)) = 1
