Shader "Custom/Effects/Scroll2LayersSwampShaderReflective" {
	Properties {
		...
		_IntensityHM ("_IntensityHM", Float) = 0.2
	...
	Fallback "Custom/Effects/Scroll2LayersSwampShaderReflectiveGLSL2"
}