Shader "Custom/OnTop/WeaponDirtAOLambertWrapMatrixSHOP" {
	Properties {
		[HideInInspector] NoScene ("Should this material be in scene?", Float) = 1
		_MainTex ("Texture", 2D) = "white" {}
		_TintColor ("Color", Vector) = (1,1,1,1)
		_LerpA ("LerpA", 2D) = "white" {}
		_ScrollX ("Base layer Scroll speed X", Float) = 0
		_ScrollY ("Base layer Scroll speed Y", Float) = 0.05
		_LerpB ("LerpB", 2D) = "white" {}
		_Scroll2X ("2nd layer Scroll speed X", Float) = 0
		_Scroll2Y ("2nd layer Scroll speed Y", Float) = 0.08
